...
<p align="center">Every java.time extension function you'll ever need.</p>
<p align="center">
  ...
  <a href="https://kotlinlang.org"><img alt="Kotlin" src="https://img.shields.io/badge/Kotlin-2.4.0-orange.svg?style=flat&logo=kotlin"/></a>
...
dependencies {
  implementation("org.eljabali.sami.javatimefun:javatimefun:4.0.3")
}  
```
